...
void secp224r1_encode(const struct string_st *public, const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
...
void secp224r1_decode(const struct string_st *public, const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
    struct ecc_curve *curve = ecc_curve_new();
    struct ecc_key *public_key = ecc_key_new();
    struct ecc_key *private_key = ecc_key_new();
    struct string_st *hash = string_new();
...
void secp224r1_encode_self(const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
    struct ecc_curve *curve = ecc_curve_new();
...
void secp224r1_decode_self(const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
    struct ecc_curve *curve = ecc_curve_new();
    struct ecc_key *key = ecc_key_new();
    struct string_st *hash = string_new();
...
void secp224r1_get_public(const struct string_st *private, struct string_st *public) {
    struct ecc_curve *curve = ecc_curve_new();
    struct ecc_key *key = ecc_key_new();
...
void secp224r1_create_sign(struct string_st *sign, const struct string_st *private, const struct string_st *hash) {
    struct ecc_curve *curve = ecc_curve_new();

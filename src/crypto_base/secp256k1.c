...
int8_t secp256k1_encode(const struct string_st *public, const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
...
int8_t secp256k1_decode(const struct string_st *public, const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
    struct ecc_key private_key;
    struct ecc_key public_key;
    struct ecc_curve curve;
    struct string_st hash;
...
int8_t secp256k1_encode_self(const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
    struct ecc_curve curve;
    struct string_st hash;
    struct ecc_key key;
    int8_t result;
...
int8_t secp256k1_decode_self(const struct string_st *private, const struct string_st *str, unsigned hash_type, unsigned crypto_type, struct string_st *res) {
    struct ecc_curve curve;
    struct string_st hash;
    struct ecc_key key;
    int8_t result;
...
int8_t secp256k1_get_public(const struct string_st *private, struct string_st *public) {
    struct ecc_curve curve;
    struct ecc_key key;
    int8_t result;
...
int8_t secp256k1_create_sign(struct string_st *sign, const struct string_st *private, const struct string_st *hash) {
...
int8_t secp256k1_check_sign(const struct string_st *sign, const struct string_st *public, const struct string_st *hash) {
    struct ecc_sign signature;
    struct ecc_curve curve;
    struct ecc_key key;
    int8_t result;
